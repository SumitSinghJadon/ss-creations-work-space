...
class FinishEntryMt(models.Model):
    finish_dt = models.ForeignKey('finishTransactionDt', on_delete=models.CASCADE, db_column='finish_dt', null=True, blank=True, db_constraint=False,)
    booking_no = models.CharField(max_length=100, default='')
    booking_id = models.ForeignKey('SampleBookingMt', on_delete=models.CASCADE, related_name='fem_booking_no', db_constraint=False, db_column='booking_id')
...
class FinishTransactionDt(models.Model):
    booking_no = models.CharField(max_length=100, default='')
    ...
    finish_type = models.TextField(max_length = 100, null=True, blank= True)
    finish_qty = models.TextField(max_length = 100, null=True, blank= True)
    size_breakup = models.TextField(max_length = 100, null=True, blank= True)
    qa_name = models.TextField(max_length = 100, null=True, blank= True)
    return_date = models.TextField(max_length = 100, null=True, blank= True)
    qa_status = models.TextField(max_length = 100, null=True, blank= True)
    ...
    hold_reason = models.TextField(max_length = 100, null=True, blank= True)
