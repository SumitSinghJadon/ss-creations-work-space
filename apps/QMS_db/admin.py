...
from QMS_db.models import OrderDt,OrderMt,ImageMaster,OrderProcess
from QMS_db.models.masters.defect_master import ProcessMaster,DefectMaster
...
admin.site.register(ImageMaster)
