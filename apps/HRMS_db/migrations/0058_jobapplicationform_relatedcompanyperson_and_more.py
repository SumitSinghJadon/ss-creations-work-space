# Generated by Django 4.2.8 on 2024-07-16 09:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('HRMS_db', '0057_remove_familydetails_job_application_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_filled', models.IntegerField(default=False)),
                ('passport_photo', models.FileField(blank=True, null=True, upload_to='job_application/')),
                ('resume', models.FileField(blank=True, null=True, upload_to='job_application/')),
