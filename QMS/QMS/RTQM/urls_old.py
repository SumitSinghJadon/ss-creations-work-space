...
from RTQM.views import get_unit, get_line_by_unit, get_planning_data_by_line


urlpatterns = [
    path('get-unit/', get_unit, name='get_unit'),
    path('get-line/', get_line_by_unit, name='get_unit'),
    path('get-planning-data/', get_planning_data_by_line, name='get_unit')
]



# from .views.api import RtqmAPI
# from .views.rtqm import RtqmDtMtView,RtqmMtDtPassView, RtqmMtDtRectifiedView
...
# from .views.sewing_line_input import SewingLineInputDtView, SewingLineInputMtView, SewingLineInputView
...
# urlpatterns = [
    ...
    # path("sewing_line_mt_input/",SewingLineInputMtView.as_view(),name="sewing-line-mt-input"),
