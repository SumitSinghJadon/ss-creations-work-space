...
# from .router import *
from .views.ob_details import ExcelDataShowView, ObDetailsView, ObDetailsShowView,ObMasterView
...
urlpatterns = [
    ...
    path('ob_details_show/',ObDetailsShowView.as_view(),name="ob-details-show"),
