...
import CallMultipleApis from '../../config/CallMultipleApis';
...
const OrderProcessPlanDT = () => {
  ...
  const fetchTableData = async () => {
    ...
    try {
      ...
      // const endpoint = '/rtqm/order_dt_view2/'
      // const response = await CallMultipleApis(endpoint);
