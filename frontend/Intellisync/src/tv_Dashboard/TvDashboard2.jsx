...
const TVDashboard2 = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${DjangoConfig.apiUrl}/rtqm/sewing_tv_dashboard2/?line_id=${line_id}`, {
        headers: {
  ...
  const topOperations = getTop3(obList, 'ob_count');
        ...
        <div className="flex h-full">
          ...
          {/* <div className="w-1/5 h-5/6 flex flex-col items-center justify-between">
            <div className="border-2 border-slate-500 w-full h-1/2 flex items-center justify-center">
              <span className="text-chocolate text-xl text-slate-200 h-48 font-semibold">Top 3 Defect</span>
              <ul>
                <li>1:- Defect</li>
              </ul>
            </div>
