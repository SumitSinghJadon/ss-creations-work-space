class AppDbRouter:
    route_app_labels = {'Sampling_db','App_db'}
...
class ISERPDbRouter:
    route_app_labels = {'IS_erp_db'}

    def db_for_read(self, model, **hints):
        return 'is_erpdb' if model._meta.app_label in self.route_app_labels else None 
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        return db == 'is_erpdb' if app_label in self.route_app_labels else None 
