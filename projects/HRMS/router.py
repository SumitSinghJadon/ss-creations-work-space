...
class AppDbRouter:
    ...
    def db_for_read(self, model, **hints):
        return 'app_db' if model._meta.app_label in self.route_app_labels else None 
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        return db == 'app_db' if app_label in self.route_app_labels else None 
...
class PayrollDbRouter:
    ...
    def db_for_read(self, model, **hints):
        return get_payroll_db_name(datetime.now()) if model._meta.app_label in self.route_app_labels else None 
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        return db == get_payroll_db_name(datetime.now()) if app_label in self.route_app_labels else None 
