...
from IS_Nexus.database import get_unit_list,get_staff_worker_attr_list
from django.db import connections
from datetime import datetime , timedelta
from django.db.models.functions import Cast
from django.db.models import F , IntegerField

class Staff_worker_attr(View):
    def get(self,request):
        ...
        #prev_date = datetime.today().strftime('%Y-%m-%d')
        ...
        context = {
            ...
            'prev_date' : prev_date,
            'unit_code' : unit_code,
            'staff_worker_list' : get_staff_worker_attr_list(str(month),str(year),unit_code)
        }
        return render(request,'staff_worker_attr.html',context)
